package com.bridgelabz.binaryrootcarousalview;
...
import com.bridgelabz.binaryrootcarousalview.databinding.ActivityCarouselPreviewBinding;
import com.bridgelabz.binaryrootcarousalview.databinding.ItemViewBinding;
    ...
    private void initRecyclerView(final RecyclerView recyclerView, final CarouselLayoutManager layoutManager, final TestAdapter adapter) {
        ...
        layoutManager.addOnItemSelectionListener(new CarouselLayoutManager.OnCenterItemSelectionListener() {
            ...
            public void onCenterItemChanged(final int adapterPosition) {
                ...
                Toast.makeText(getBaseContext(),"message+"+adapterPosition,Toast.LENGTH_LONG).show();
    ...
    private static final class TestAdapter extends RecyclerView.Adapter<TestViewHolder> {
        ...
        public void onBindViewHolder(final TestViewHolder holder, final int position) {
          //  holder.mItemViewBinding.cItem1.setText(String.valueOf(mPosition[position]));
           ...
           //holder.mItemViewBinding.imageview.setImageResource(R.drawable.bg);
