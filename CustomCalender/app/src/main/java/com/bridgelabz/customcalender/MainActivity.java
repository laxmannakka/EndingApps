package com.bridgelabz.customcalender;
    ...
    public class GridCellAdapter extends BaseAdapter implements View.OnClickListener
    {
        ...
        private void printMonth(int mm, int yy){
            ...
            for (int i = 1; i <= daysInMonth; i++){
                if (i == getCurrentDayOfMonth())
                    ...
                    list.add(String.valueOf(i) + "-Lightblue" + "-" + getMonthAsString(currentMonth) + "-" + yy);
            }
        ...
        public View getView(int position, View convertView, ViewGroup parent){
            ...
            if (row == null){
                ...
                row = inflater.inflate(R.layout.calender_cell, parent, false);
            }
         ...
         //  gridcell = (Button) row.findViewById(R.id.calendar_day_gridcell);
          TextView gridcell =(TextView)row.findViewById(R.id.calendar_day_gridcell);
            ...
            if (day_color[1].equals("Lightblue"))
                gridcell.setTextColor(getResources().getColor(R.color.lightblue));
